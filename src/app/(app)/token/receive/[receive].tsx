import { Share, Alert, Platform, Dimensions, Modal, Pressable } from "react-native";
...
const ModalQRContainer = styled.View<{ theme: ThemeType }>`
  background-color: ${(props) => props.theme.colors.white};
  padding: ${(props) => props.theme.spacing.medium};
  border-radius: ${(props) => props.theme.borderRadius.default};
  justify-content: center;
...
const ModalCloseButton = styled.Pressable<{ theme: ThemeType }>`
  background-color: ${(props) => props.theme.colors.primary};
...
const ModalCloseText = styled.Text<{ theme: ThemeType }>`
  color: ${(props) => props.theme.colors.white};
  font-family: ${(props) => props.theme.fonts.families.openBold};
